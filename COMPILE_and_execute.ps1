...
pyinstaller --onefile --windowed --add-data "cheer.mp3;." --add-data "words.txt;." --add-data "code.png;." --add-data ".apikey.txt;." --hidden-import pygame --icon code.ico --name $outputName $sourceFile
